...
[點擊下載 aar 檔](https://drive.google.com/file/d/0BxLWenH1MuEednV6YVAwQ2gxd0E/view)

[ xuite 部落格](http://blog.xuite.net/kalian/code/523154627)
...
```
    多國語系資訊
    回傳 國家名稱,名稱簡寫,地區碼 三樣資訊
```

# 使用方式：

```
    取得國家名稱陣列： getCountriesName()
    取得國家名稱簡寫陣列： getCountriesShorthand()
    取得地區碼陣列： getCountriesCode()
```
...
![使用圖片](http://a.share.photo.xuite.net/kalian/1a8ed90/20235819/1167891813_x.jpg)
